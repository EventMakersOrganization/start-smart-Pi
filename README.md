...
### Prerequisites
Node.js v18+ • MongoDB v6+ • Docker • Ollama

### Quick Start

```bash
# Clone and install
git clone https://github.com/your-org/adaptive-learning-platform.git
...
**Default Login:** `student@esprit.tn` / `student123`
...
│       ├── features/  # Dashboard, BrainRush, etc.
...
| Phase | Sprints | Status | Deliverables |
|-------|---------|--------|--------------|
| **Foundation** | 1-4 | ✅ | Auth, User Management, AI Setup |
| **Core Learning** | 5-8 | 🚧 | AI Agent, Adaptive Engine, BrainRush |
| **Intelligence** | 9-11 | 📅 | At-risk Detection, BI Dashboards |
| **Finalization** | 12 | 📅 | Testing, Deployment |
