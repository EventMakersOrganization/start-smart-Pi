...
import { ClassInstructor, ClassInstructorSchema } from './schemas/class-instructor.schema';
...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([{ name: ClassInstructor.name, schema: ClassInstructorSchema }]),
